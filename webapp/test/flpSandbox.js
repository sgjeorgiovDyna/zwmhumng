					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Motovario HU Management",
									"targetURL": "#zmwhumng-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zmwhumng-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmwhumng",
									"url": sap.ui.require.toUrl("zmwhumng")
								}
							}
						}
					}
